...
def search_arcade(q: str = ""):
    ...
    # We select the strings we want, and include a hidden "SortYear" column.
    # Games get their actual release year, while consoles get set to 9999 
    # so they automatically drop to the absolute bottom of the chronological list!
    query = """
