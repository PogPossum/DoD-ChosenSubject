...
<p>This project is gonna function as an extension of my retro games/consoles database, <i>Ashii's Arcade</i>, much like my console application where I can access my database via a console which only works on my local network, I want to have a website/webapp where I can access the data on my database publicly, so I can browse my collection and search for specific games/consoles, <i>kinda something like Bilbasen</i>.</p>
